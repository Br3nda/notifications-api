...
def post_notification(notification_type):
    ...
    service_email_reply_to_id = form.get("service_email_reply_to_id", None)

    check_service_can_schedule_notification(authenticated_service.permissions, scheduled_for)

    check_rate_limiting(authenticated_service, api_user)

    check_service_email_reply_to_id(service_email_reply_to_id)
...
def process_sms_or_email_notification(*, form, notification_type, api_key, template, service):
    ...
    notification = persist_notification(
        ...
        simulated=simulated,
        reply_to_id=form.get('service_email_reply_to_id', None)
    )
