...
from app.dao.notifications_dao import dao_update_notification, dao_get_notification_reply_to_email_address
...
def send_email_to_provider(notification):
    ...
    if notification.status == 'created':
        ...
        if service.research_mode or notification.key_type == KEY_TYPE_TEST:
            ...
            email_reply_to = dao_get_notification_reply_to_email_address(notification.id)
